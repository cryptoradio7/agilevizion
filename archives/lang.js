...
const translations = {
    fr: {
        ...
        safe_title: "SAFe SPC",
        safe_desc: "Transformation Agile à l’échelle",
        cert_portfolio_title: "SAFe Lean Portfolio",
        cert_portfolio_desc: "Gestion de portefeuille IT",
        iso_title: "DORA, ISO 27001",
        iso_desc: "Conformité réglementaire en matière de cybersécurité",
        cert_service_title: "ITIL V4 & Service Management",
        cert_service_desc: "Gestion des services",
        prince2_title: "PRINCE2",
        prince2_desc: "Gestion de projets structurée",
        scrum_title: "Scrum Master",
        scrum_desc: "Facilitation Agile",
        project_title: "Gestion de projets",
        project_desc: "Méthodologies Agile et Waterfall",
        po_title: "POPM Product Owner",
        po_desc: "Gestion agile des produits",

        // Approche
        approach_title: "Mon Approche",
        approach_intro: "De l'analyse de vos besoins au démarrage de la mission",
        step1_title: "1. Écoute des Besoins",
        step1_desc: "Analyse approfondie de vos enjeux et objectifs métier",
        step2_title: "2. Cadrage Mission",
        step2_desc: "Définition du périmètre et des livrables attendus",
        step3_title: "3. Estimation & Méthode",
        step3_desc: "Charge de travail, objectifs, méthodologie et pricing",
        step4_title: "4. Contractualisation",
        step4_desc: "Formalisation des accords et conditions de collaboration",
        step5_title: "5. Démarrage Mission",
        ...
        role_agile_4: "Coaching des équipes IT pour renforcer la culture agile",
        role_agile_5: "Suivi des métriques d'agilité",

        role_portfolio_title: "Gestion de Portefeuille IT",
        role_portfolio_1: "Alignement stratégique de l'IT avec les objectifs métiers",
        role_portfolio_2: "Optimisation des processus selon le cadre COBIT 5",
        role_portfolio_3: "Cartographie des projets en cours",
        role_portfolio_4: "Identification, évaluation et priorisation des projets candidats",
        role_portfolio_5: "Suivi, gestion et optimisation continue du portefeuille de projets IT",
        role_portfolio_6: "Représentation de l'IT au COMEX via un reporting clair et des KPI pertinents",

        role_project_title: "Gestion de Projets",
        role_project_1: "Planification et suivi détaillé des projets",
        role_project_2: "Gestion des ressources et des budgets",
        role_project_3: "Coordination efficace des équipes impliquées",
        role_project_4: "Gestion des risques et des livrables",
        role_project_5: "Évaluation post-projet pour amélioration continue",

        role_product_title: "Product Owner",
        role_product_1: "Définition claire de la vision produit",
        role_product_2: "Gestion proactive du Product Backlog",
        role_product_3: "Priorisation des User Stories avec les équipes",
        role_product_4: "Interface avec les parties prenantes pour alignement",
        role_product_5: "Validation des incréments produit livrés",

        role_scrum_title: "Scrum Master",
        role_scrum_1: "Facilitation des événements Scrum",
        role_scrum_2: "Coaching de l'équipe de développement",
        ...
        role_business_3: "Rédaction de spécifications fonctionnelles",
        ...
        mission_type_1: "Transformation Agile IT",
        mission_type_2: "Gestion de Portefeuille IT",
        mission_type_3: "Cybersécurité",
        mission_type_4: "Service Management",
        mission_type_5: "Gestion de Projets",
        mission_type_6: "Product Owner",
        mission_type_7: "Scrum Master",
        ...
        agile_text3: "Mise en place de métriques d'agilité et de tableaux de bord pour mesurer l'efficacité des équipes et l'amélioration continue des processus.",
        
        product_management_title: "Cybersécurité",
        product_management_description: "Audit pour la conformité de votre sécurité IT avec les normes sécuritaires en vigueur (ex: DORA, ISO 27001).",
        
        project_title: "Gestion de projets agile et waterfall",
        project_text1: "Gestion de projets structurée avec méthodologies Agile et Waterfall selon les besoins du projet.",
        project_text2: "Exemple: Migration et consolidation des données CRM vers Salesforce pour une intégration métier-IT fluide.",
        
        digital_title: "Transformation Digitale",
        digital_text1: "Élaboration de la Stratégie digitale et présentation au Comité Exécutif d'une feuille de route digitale alignée sur les objectifs métiers.",
        digital_text2: "Incluant des innovations comme la signature électronique.",
        digital_text3: "Et la digitalisation du parcours client.",
        
        service_title: "Service Management",
        service_text1: "Migration ITSM vers ServiceNow: migration des processus ITSM (incidents, problèmes, changements) vers ServiceNow pour optimiser la livraison des services.",
        service_text2: "Gestion des fournisseurs & optimisation des SLAs: Alignement stratégique des contrats IT.",
        service_text3: "Renforcement des KPIs et introduction de pénalités pour non-conformité.",
        ...
        expertise_cyber_text: "Audit, conformité (DORA, ISO 27001) et cybersécurité renforcée.",
    ...
    en: {
        ...
        mission_type_1: "IT Agile Transformation",
        mission_type_2: "IT Portfolio Management",
        mission_type_3: "Cybersecurity",
        mission_type_4: "Service Management",
        mission_type_5: "Project Management",
        mission_type_6: "Product Owner",
        mission_type_7: "Scrum Master",
...
function getLanguageFromURL() {
    ...
    return lang === 'en' ? 'en' : 'fr'; // Par défaut 'fr' si pas de paramètre ou invalide
}
...
function translate(lang) {
    console.log('Début de la traduction vers:', lang);
    console.log('État actuel de la langue:', document.documentElement.getAttribute('data-lang'));
    ...
    try {
        ...
        document.querySelectorAll('[data-translate]').forEach(element => {
            ...
            if (translation) {
                if (element.tagName === 'INPUT' || element.tagName === 'TEXTAREA') {
                    ...
                    // Pour les éléments select, on ne fait rien ici
                    // Les options seront traitées séparément
                ...
                console.warn('Traduction non trouvée pour:', key);
            }
        });

        // Traiter spécifiquement le select de type de mission
        const missionSelect = document.querySelector('select[name="type_mission"]');
        if (missionSelect) {
            // Traduire d'abord l'option par défaut
        ...
        console.log('Traduction terminée. Nouvelle langue:', document.documentElement.getAttribute('data-lang'));
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.addEventListener('popstate', () => {
        ...
        console.log('Navigation: nouvelle langue détectée:', newLang);
        translate(newLang);
    });
}); 
